    ...
    <div className="space-y-5">
      <section className="mandi-location-bar">
        <div>
          ...
          <h2 className="mt-2 text-2xl font-black text-[#202723]">{market.village || market.district}</h2>
          <p className="mt-1 text-sm font-semibold text-zinc-600">Village mapped by GPS · mandi rates from {market.district}, {market.state} · approximately {market.distanceKm} km</p>
        </div>
